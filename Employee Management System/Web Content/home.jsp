<%@page import="com.sandeep.beans.Employee"%>
...
<body>
	...
	List<Employee> listEmp = (List<Employee>) list;
	...
	<H2>
		Welcome to Home
		<%=emp.getEmail()%>
		<a href="${pageContext.request.contextPath}/updateCurrentUser.jsp">Profile</a>
	</H2>
		...
		<c:forEach items="${listEmp }" var="emp">
			...
			<tr>
				...
				<c:if test="${currentUser.getPermission().equals('admin') }">
					...
					<td><a
						href="${pageContext.request.contextPath}/update.jsp?edit=true&&index=${count}&&currentUser=false"><button>Edit
								Details</button></a></td>
					<td><a
